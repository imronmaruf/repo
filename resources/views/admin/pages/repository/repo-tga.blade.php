            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="dosen">Dosen Pembimbing 1</label>
                            <select class="form-control" id="dosbing1" placeholder="Dosbing 1">
                                <option>Dosbing 1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                        ...
                        <div class="form-group">
                            <label for="dosen">Dosen Pembimbing 2</label>
                            <select class="form-control" id="dosbing2" placeholder="Dosbing 2">
                                <option>Dosbing 1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
